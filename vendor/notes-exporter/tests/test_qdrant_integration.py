...
class TestConfig:
    ...
    def test_qdrant_cloud_url_detection(self):
        assert _is_qdrant_cloud_url("https://my-cloud.qdrant.io:6333")
        assert _is_qdrant_cloud_url("https://cloud.qdrant.io")
        assert not _is_qdrant_cloud_url("https://example.com/cloud.qdrant.io.evil")
        assert not _is_qdrant_cloud_url("not a url")
