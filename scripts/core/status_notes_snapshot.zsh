...
LIB_RENDER_HELPERS="${REPO_ROOT}/scripts/core/status_render_helpers.zsh"
...
if [[ ! -f "$LIB_RENDER_HELPERS" ]]; then
  echo "missing core/status_render_helpers: $LIB_RENDER_HELPERS" >&2
  exit 1
fi
