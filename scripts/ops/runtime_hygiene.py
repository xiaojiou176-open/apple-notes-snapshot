...
def repo_local_entries(repo_root: Path) -> list[dict]:
    surfaces = [
        ...
        ("repo-local-browser-proof", repo_root / ".runtime-cache" / "browser-proof"),
        ("repo-local-history-rebuild", repo_root / ".runtime-cache" / "phase1"),
        ("repo-local-history-rebuild-rollback", repo_root / ".runtime-cache" / "phase1-history-rebuild"),
        ("repo-local-registry-stage", repo_root / ".runtime-cache" / "mcp-registry-lane" / "out"),
